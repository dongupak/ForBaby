...
- (void)viewDidLoad {
	...
	NSString *path2 = [[NSBundle mainBundle] pathForResource:@"whoBuang" ofType:@"mp3"];
	NSURL *url2 = [NSURL fileURLWithPath:path2];
	whoBuang = [[AVAudioPlayer alloc] initWithContentsOfURL:url2 error:nil];
...
- (IBAction)right:(id)sender{
	[whoBuang play];
	whoexam5 *nextexam = [[whoexam5 alloc] init];
