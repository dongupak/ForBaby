...
- (void)viewDidLoad {
	...
	NSString *path2 = [[NSBundle mainBundle] pathForResource:@"whoKoalla" ofType:@"mp3"];
	NSURL *url2 = [NSURL fileURLWithPath:path2];
	whoKoalla = [[AVAudioPlayer alloc] initWithContentsOfURL:url2 error:nil];
	

	
	//	[startsn play];
	
	self.navigationItem.title = @"세번째 마당";
...
- (IBAction)right:(id)sender{
	[whoKoalla play];
	whoexam4 *nextexam = [[whoexam4 alloc] init];
